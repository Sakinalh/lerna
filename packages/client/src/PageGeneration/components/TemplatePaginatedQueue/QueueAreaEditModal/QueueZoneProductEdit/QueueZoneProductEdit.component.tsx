...
import { QueueZoneProductForm } from "./QueueZoneProductForm/QueueZoneProductForm.component";
...
interface QueueZoneProductEditProps {
    ids: {
        rowId: number,
        pageId: string;
        zoneId: string;
...
export function QueueZoneProductEdit({ ids, onClose, keywordId }: QueueZoneProductEditProps) {
