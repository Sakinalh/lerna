...
import { QueueZoneTextEditForm } from "./QueueZoneTextEditForm/QueueZoneTextEditForm.component";
...
interface QueueZoneTextEditProps {
    ids: {
        rowId: number,
        pageId: string;
        zoneId: string;
...
export function QueueZoneTextEdit({ ids, onClose, keywordId }: QueueZoneTextEditProps) {
    ...
    <div className={classes.root}>
      ...
      <div className={classes.panel}>
        ...
        <TabPanel value={value} index="1">
          <QueueZoneTextEditForm datum={selection}
            ids={ids}
            onClose={onClose}
